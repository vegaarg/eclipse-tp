...
/*    public boolean detectarColision(double x1, double x2, double y1, double y2, double ancho2){             // Suma +40 desde el centro de la plataforma para que la y de Pep este
        if (y1 + 40 == y2 && (x1 > x2 - (ancho2 / 2) && x1 < x2 + (ancho2 / 2))){                           // por arriba de la plataforma. Luego, chequea que el x de Pep este en
            return true;                                                                                    // el ancho de la plataforma. Si se cumplen ambas condiciones, esta
        }                                                                                                   // en la plataforma.
        return false;
    } */
